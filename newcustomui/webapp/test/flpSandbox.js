		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cominkuinewcustomui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominkuinewcustomui-display": {
								"semanticObject": "cominkuinewcustomui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ink.ui.newcustomui",
									"url": sap.ui.require.toUrl("com/ink/ui/newcustomui")
								}
							}
						}
					}
